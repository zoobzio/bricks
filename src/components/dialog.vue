...
export const useDialogUI = defineComponentUI({
  slots: {
    ...
    content:
      "fixed left-1/2 top-1/2 z-50 text-ui-on-surface-container rounded w-full max-w-lg -translate-x-1/2 -translate-y-1/2 border border-ui-outline bg-ui-surface-container pa-spacing-m flex flex-col gap-spacing-m shadow-2xl shadow-ui-outline",
  },
});
